        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input type="email" name="email" value={formData.email} onChange={handleChange}
              ...
              className={'w-full border rounded px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ' + (errors.email ? 'border-red-500' : 'border-gray-300')} />
          ...
          <div>
            ...
            <input type="password" name="password" value={formData.password} onChange={handleChange}
              ...
              className={'w-full border rounded px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ' + (errors.password ? 'border-red-500' : 'border-gray-300')} />
